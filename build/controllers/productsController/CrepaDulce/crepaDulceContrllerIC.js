        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM cdic WHERE adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'SELECT * FROM cdic WHERE id = ? AND adminId = ?';
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO cdic SET ?', { ingrediente_com: ingrediente, tipo: tipo, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
                    ...
                    yield databaseuser_1.default.promise().query('SELECT * FROM sucursales WHERE adminId = ?', [adminId])
                        ...
                        sucursales[0].forEach((sucursal) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            yield database_1.default.promise().query('INSERT INTO cdice SET ?', [registro])
                                .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query = 'DELETE FROM cdic WHERE id = ? AND adminId = ?';
                    ...
                    yield database_1.default.promise().query('DELETE FROM cdice WHERE product_id = ? AND adminId = ?', [ingredienteId, adminId])
                        .then(() => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    const query1 = 'SELECT * FROM cdic WHERE id = ? AND adminId = ?';
                    ...
                    if (parseInt(ingrediente1.inventario) === ingrediente[0].inventario) {
                        ...
                        const query = 'UPDATE cdic SET ? WHERE id = ? AND adminId = ?';
                        ...
                        yield database_1.default.promise().query('UPDATE cdice SET ? WHERE product_id = ? AND adminId = ?', [registro, ingredienteId, adminId])
                            .then(() => {
...
exports.default = crepaDulceICController;
