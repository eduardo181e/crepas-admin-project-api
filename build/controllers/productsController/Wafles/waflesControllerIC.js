        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('INSERT INTO wic SET ?', { ingrediente_com: ingrediente, tipo: tipo, inventario: req.body.inventario, adminId: adminId })
                        .then((result) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    yield database_1.default.promise().query('DELETE FROM wice WHERE product_id = ? AND adminId = ?', [ingredienteId, adminId])
                        .then(() => {
            ...
            if (req.headers['authorization'] === undefined) {
                ...
                try {
                    ...
                    if (parseInt(ingrediente1.inventario) === ingrediente[0].inventario) {
                        ...
                        yield database_1.default.promise().query('UPDATE wice SET ? WHERE product_id = ? AND adminId = ?', [registro, ingredienteId, adminId])
                            .then(() => {
